...
- Buenos días. Mi nombre es María Belén Valenzuela y hoy les presento Easy Breakfast, un modelo de negocio que redefine la primera comida del día fusionando tres pilares: nutrición, tecnología y optimización del tiempo. 

- Nuestra propuesta es un plan de preventa online de desayunos saludables diseñado para el ritmo de la vida moderna.
...
## 3. Solución: El Ecosistema Easy Breakfast (30 segundos)

- Nuestro ecosistema se basa en la accesibilidad digital.

- Los pedidos se gestionan 100% de forma remota, asegurando una entrega programada antes de que el cliente inicie su jornada laboral o universitaria.

- El menú destaca por su balance nutricional, con productos diferenciados como hotcakes de frutas frescas o el tradicional ponche de habas.

## 4. Status Quo vs Nuestro modelo: Diferenciación Competitiva (20 segundos)

- A diferencia de la preparación en casa que requiere mucho tiempo, o la comida rápida que carece de valor nutricional.

- Easy Breakfast ofrece 'tiempo cero' de inversión para el cliente en la mañana. Somos la única opción que combina alto valor nutricional con una logística de entrega directa y cero desperdicios bajo demanda.

## 5. Arquetipo de Cliente y Mercado (30 segundos)

Nuestros arquetipos son:

- El cuidador como arquetipo primario que es compasivo, generoso y
proteccionista.

- El héroe como arquetipo secundario que es defensor y protector, siempre dispuesto a enfrentar grandes desafíos con el objetivo de salir victorioso.

- En cuanto a nuestro mercado objetivo "Nuestro foco inicial es el sector de Iñaquito, una zona urbana de alta densidad con más de 42,000 habitantes. Nos dirigimos a adultos ejecutivos y estudiantes de entre 20 y 45 años. Son personas con un estilo de vida activo que valoran la eficiencia y son usuarios frecuentes de plataformas digitales.

## 6. El Motor Operativo: Como funciona Easy Breakfast (20 segundos)
...
----------------- Cosas que te pueden preguntas -----------------

Objetivo General:

- Diseñar bajo la metodología CANVAS la viabilidad de un plan de negocio rentable de preventa online de desayunos saludables dirigido a profesionales con poco tiempo disponible.

Objetivos especificos:

- Analizar los elementos de la metodología de negocios CANVA con la finalidad
de estructurar la base del proyecto.
- Desarrollar un estudio del mercado objetivo que permita evaluar la viabilidad y
aceptación comercial del negocio.
- Analizar factores internos y externos que determinen la viabilidad del proyecto